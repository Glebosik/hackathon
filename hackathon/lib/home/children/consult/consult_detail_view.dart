...
class ConsultDetailView extends StatelessWidget {
  ConsultDetailView(
      {super.key, required this.bottomKey, required this.application});

  final Key bottomKey;
  final Application application;
  final isTest = FirebaseAuth.instance.currentUser!.email == 'test1@test.ru';
                                  ...
                                  onPressed: () async {
                                            ...
                                            content: SizedBox(
                                              ...
                                              child: Center(
                                                ...
                                                children: [
                                                  ...
                                                  const SizedBox(height: 10),
                                                  Text(
                                                    'Возможно, вы больше не сможете создать запись на это время.',
                                    ...
                                    if (isToDelete is bool &&
                                      ...
                                      FirebaseFirestore.instance
                                          .collection(
                                              'inspectors/${application.inspectorId}/applications')
                                          .doc(
