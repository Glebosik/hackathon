...
class ApplicationViewFail extends StatelessWidget {
  const ApplicationViewFail({super.key, required this.bottomKey});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        ...
        children: [
          const Text(
              'Не удалось получить данные о записях на консультирование'),
